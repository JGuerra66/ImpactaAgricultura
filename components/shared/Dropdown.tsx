import {
  ...
  import { IProductCategory } from "@/lib/mongodb/database/models/productCategory.model"
          ...
          <AlertDialog>
            ...
            <AlertDialogContent className="bg-white">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  <Input type="text" placeholder="Categoria" className="input-field mt-3" onChange={(e) => setNewCategory(e.target.value)} />
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
