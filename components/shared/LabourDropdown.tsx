...
const [valuePerHectare, setValuePerHectare] = useState(0); // new state for value per hectare
      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="bg-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <Input type="text" placeholder="Labor" className="input-field mt-3" onChange={(e) => setNewLabour(e.target.value)} />
              <Input type="number" placeholder="Valor por Hectarea" className="input-field mt-3" onChange={(e) => setValuePerHectare(Number(e.target.value))} />
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
